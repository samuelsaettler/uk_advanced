...
public class UserControllerTest {
    ...
    @Test
    @WithMockUser
    public void updateUserById_requestUserWithWrongEmail_returnInvalidEmailError() throws Exception {
        UserDTO userDTOInvalidEmail = userDTOToBeTestedAgainst;
        userDTOInvalidEmail.setEmail("BadRequest");
        String DTOToJson = new ObjectMapper().writeValueAsString(userDTOInvalidEmail);

        mvc.perform(
                MockMvcRequestBuilders
                        .put("/users/{id}", userDTOInvalidEmail.getId())
                        .content(DTOToJson)
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON))
